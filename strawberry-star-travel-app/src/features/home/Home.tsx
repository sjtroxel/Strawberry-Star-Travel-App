  ...
  return (
    <main
      className="
        ...
        bg-gradient-to-b from-black via-gray-900 to-rose-950
      "
    >
      {/* Hero Section */}
      <section className="flex flex-col items-center justify-center text-center px-6 pt-48 pb-20">
      ...
      {/* Feature Teasers */}
      <section className="max-w-6xl mx-auto px-6 pb-24 grid grid-cols-1 md:grid-cols-3 gap-8 w-full">
